...
## Next steps
- [ ] Balu hands-on checks, batches 2+3: popup shadow, badge status row + gradient during a dictation, tray left-click + Pause submenu, history search/chips/pin/bulk select, >30s recording confirm, panel countdown bar + pin, WPM footer.
