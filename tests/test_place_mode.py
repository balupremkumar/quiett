...
class TestInsertEscalationOptOut:
    """escalate=False returns the status and shows nothing, for a caller that
    has its own answer to a refusal. The reserved place key was that caller
    until 2026-08-23; the flag stays as the documented quiet path."""
